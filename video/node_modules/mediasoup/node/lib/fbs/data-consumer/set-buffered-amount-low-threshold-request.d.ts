...
export declare class SetBufferedAmountLowThresholdRequest implements flatbuffers.IUnpackableObject<SetBufferedAmountLowThresholdRequestT> {
...
export declare class SetBufferedAmountLowThresholdRequestT implements flatbuffers.IGeneratedObject {
    threshold: number;
