...
export declare class GetBufferedAmountResponse implements flatbuffers.IUnpackableObject<GetBufferedAmountResponseT> {
...
export declare class GetBufferedAmountResponseT implements flatbuffers.IGeneratedObject {
    bufferedAmount: number;
