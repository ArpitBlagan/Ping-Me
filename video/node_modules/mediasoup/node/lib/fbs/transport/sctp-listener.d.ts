...
import { Uint16String, Uint16StringT } from '../../fbs/common/uint16-string';
export declare class SctpListener implements flatbuffers.IUnpackableObject<SctpListenerT> {
...
export declare class SctpListenerT implements flatbuffers.IGeneratedObject {
