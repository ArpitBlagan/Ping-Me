...
export declare class SetMaxIncomingBitrateRequest implements flatbuffers.IUnpackableObject<SetMaxIncomingBitrateRequestT> {
...
export declare class SetMaxIncomingBitrateRequestT implements flatbuffers.IGeneratedObject {
    maxIncomingBitrate: number;
