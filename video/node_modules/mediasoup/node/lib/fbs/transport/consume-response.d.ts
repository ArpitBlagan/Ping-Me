...
export declare class ConsumeResponse implements flatbuffers.IUnpackableObject<ConsumeResponseT> {
...
export declare class ConsumeResponseT implements flatbuffers.IGeneratedObject {
    paused: boolean;
    producerPaused: boolean;
