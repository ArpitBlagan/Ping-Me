...
export declare class CloseDataConsumerRequest implements flatbuffers.IUnpackableObject<CloseDataConsumerRequestT> {
...
export declare class CloseDataConsumerRequestT implements flatbuffers.IGeneratedObject {
