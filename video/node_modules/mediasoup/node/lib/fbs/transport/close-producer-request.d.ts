...
export declare class CloseProducerRequest implements flatbuffers.IUnpackableObject<CloseProducerRequestT> {
...
export declare class CloseProducerRequestT implements flatbuffers.IGeneratedObject {
