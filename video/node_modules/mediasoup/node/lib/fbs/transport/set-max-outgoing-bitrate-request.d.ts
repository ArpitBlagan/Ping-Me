...
export declare class SetMaxOutgoingBitrateRequest implements flatbuffers.IUnpackableObject<SetMaxOutgoingBitrateRequestT> {
...
export declare class SetMaxOutgoingBitrateRequestT implements flatbuffers.IGeneratedObject {
    maxOutgoingBitrate: number;
