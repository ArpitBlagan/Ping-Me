...
export declare class CloseConsumerRequest implements flatbuffers.IUnpackableObject<CloseConsumerRequestT> {
...
export declare class CloseConsumerRequestT implements flatbuffers.IGeneratedObject {
