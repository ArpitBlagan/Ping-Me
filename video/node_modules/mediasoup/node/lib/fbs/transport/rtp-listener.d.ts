...
export declare class RtpListener implements flatbuffers.IUnpackableObject<RtpListenerT> {
...
export declare class RtpListenerT implements flatbuffers.IGeneratedObject {
