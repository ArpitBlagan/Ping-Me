...
export declare class ActiveSpeakerObserverOptions implements flatbuffers.IUnpackableObject<ActiveSpeakerObserverOptionsT> {
...
export declare class ActiveSpeakerObserverOptionsT implements flatbuffers.IGeneratedObject {
    interval: number;
