...
export declare class AudioLevelObserverOptions implements flatbuffers.IUnpackableObject<AudioLevelObserverOptionsT> {
...
export declare class AudioLevelObserverOptionsT implements flatbuffers.IGeneratedObject {
    maxEntries: number;
    threshold: number;
    interval: number;
