...
export declare class CreateRouterRequest implements flatbuffers.IUnpackableObject<CreateRouterRequestT> {
...
export declare class CreateRouterRequestT implements flatbuffers.IGeneratedObject {
