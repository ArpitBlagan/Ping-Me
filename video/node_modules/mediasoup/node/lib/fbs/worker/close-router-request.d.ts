...
export declare class CloseRouterRequest implements flatbuffers.IUnpackableObject<CloseRouterRequestT> {
...
export declare class CloseRouterRequestT implements flatbuffers.IGeneratedObject {
