...
export declare class CloseWebRtcServerRequest implements flatbuffers.IUnpackableObject<CloseWebRtcServerRequestT> {
...
export declare class CloseWebRtcServerRequestT implements flatbuffers.IGeneratedObject {
