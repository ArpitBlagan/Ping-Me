...
export declare class StringUint8 implements flatbuffers.IUnpackableObject<StringUint8T> {
...
export declare class StringUint8T implements flatbuffers.IGeneratedObject {
