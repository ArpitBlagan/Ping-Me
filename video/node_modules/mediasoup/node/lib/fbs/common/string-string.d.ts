...
export declare class StringString implements flatbuffers.IUnpackableObject<StringStringT> {
...
export declare class StringStringT implements flatbuffers.IGeneratedObject {
