...
export declare class Uint16String implements flatbuffers.IUnpackableObject<Uint16StringT> {
...
export declare class Uint16StringT implements flatbuffers.IGeneratedObject {
    key: number;
    value: string | Uint8Array | null;
    constructor(key?: number, value?: string | Uint8Array | null);
    pack(builder: flatbuffers.Builder): flatbuffers.Offset;
}
//# sourceMappingURL=uint16-string.d.ts.map