...
export declare class StringStringArray implements flatbuffers.IUnpackableObject<StringStringArrayT> {
...
export declare class StringStringArrayT implements flatbuffers.IGeneratedObject {
