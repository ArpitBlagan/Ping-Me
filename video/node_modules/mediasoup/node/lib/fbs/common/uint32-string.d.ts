...
export declare class Uint32String implements flatbuffers.IUnpackableObject<Uint32StringT> {
...
export declare class Uint32StringT implements flatbuffers.IGeneratedObject {
    key: number;
    value: string | Uint8Array | null;
    constructor(key?: number, value?: string | Uint8Array | null);
    pack(builder: flatbuffers.Builder): flatbuffers.Offset;
}
//# sourceMappingURL=uint32-string.d.ts.map