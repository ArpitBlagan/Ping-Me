...
export declare class ConsumerScore implements flatbuffers.IUnpackableObject<ConsumerScoreT> {
...
export declare class ConsumerScoreT implements flatbuffers.IGeneratedObject {
    score: number;
    producerScore: number;
