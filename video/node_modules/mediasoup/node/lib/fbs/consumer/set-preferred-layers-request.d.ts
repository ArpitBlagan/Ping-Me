...
export declare class SetPreferredLayersRequest implements flatbuffers.IUnpackableObject<SetPreferredLayersRequestT> {
...
export declare class SetPreferredLayersRequestT implements flatbuffers.IGeneratedObject {
