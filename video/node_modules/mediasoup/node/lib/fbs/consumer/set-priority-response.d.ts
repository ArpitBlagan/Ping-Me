...
export declare class SetPriorityResponse implements flatbuffers.IUnpackableObject<SetPriorityResponseT> {
...
export declare class SetPriorityResponseT implements flatbuffers.IGeneratedObject {
    priority: number;
