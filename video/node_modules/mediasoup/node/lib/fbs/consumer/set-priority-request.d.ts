...
export declare class SetPriorityRequest implements flatbuffers.IUnpackableObject<SetPriorityRequestT> {
...
export declare class SetPriorityRequestT implements flatbuffers.IGeneratedObject {
    priority: number;
