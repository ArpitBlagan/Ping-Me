...
export declare class SetPreferredLayersResponse implements flatbuffers.IUnpackableObject<SetPreferredLayersResponseT> {
...
export declare class SetPreferredLayersResponseT implements flatbuffers.IGeneratedObject {
