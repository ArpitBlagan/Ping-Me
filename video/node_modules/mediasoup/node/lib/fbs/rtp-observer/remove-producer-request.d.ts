...
export declare class RemoveProducerRequest implements flatbuffers.IUnpackableObject<RemoveProducerRequestT> {
...
export declare class RemoveProducerRequestT implements flatbuffers.IGeneratedObject {
