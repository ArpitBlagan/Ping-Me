...
export declare class AddProducerRequest implements flatbuffers.IUnpackableObject<AddProducerRequestT> {
...
export declare class AddProducerRequestT implements flatbuffers.IGeneratedObject {
