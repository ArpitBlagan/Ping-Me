...
export declare class CloseRtpObserverRequest implements flatbuffers.IUnpackableObject<CloseRtpObserverRequestT> {
...
export declare class CloseRtpObserverRequestT implements flatbuffers.IGeneratedObject {
