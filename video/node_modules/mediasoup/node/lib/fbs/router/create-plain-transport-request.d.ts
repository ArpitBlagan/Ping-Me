...
export declare class CreatePlainTransportRequest implements flatbuffers.IUnpackableObject<CreatePlainTransportRequestT> {
...
export declare class CreatePlainTransportRequestT implements flatbuffers.IGeneratedObject {
