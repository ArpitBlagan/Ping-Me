...
export declare class CreateDirectTransportRequest implements flatbuffers.IUnpackableObject<CreateDirectTransportRequestT> {
...
export declare class CreateDirectTransportRequestT implements flatbuffers.IGeneratedObject {
