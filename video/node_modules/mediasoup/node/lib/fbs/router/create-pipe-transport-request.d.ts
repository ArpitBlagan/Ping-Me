...
export declare class CreatePipeTransportRequest implements flatbuffers.IUnpackableObject<CreatePipeTransportRequestT> {
...
export declare class CreatePipeTransportRequestT implements flatbuffers.IGeneratedObject {
