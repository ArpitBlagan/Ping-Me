...
export declare class CodecMapping implements flatbuffers.IUnpackableObject<CodecMappingT> {
...
export declare class CodecMappingT implements flatbuffers.IGeneratedObject {
    payloadType: number;
    mappedPayloadType: number;
