...
export declare class RtcpFeedback implements flatbuffers.IUnpackableObject<RtcpFeedbackT> {
...
export declare class RtcpFeedbackT implements flatbuffers.IGeneratedObject {
